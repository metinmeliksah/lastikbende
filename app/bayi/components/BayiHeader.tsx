...
export default function BayiHeader({ notifications, isSidebarOpen, setIsSidebarOpen }: BayiHeaderProps) {
  return (
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center">
              <span className="text-sm font-medium text-purple-600">AY</span>
            </div>
