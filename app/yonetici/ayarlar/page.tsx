            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 w-full px-4 py-2 rounded-lg border border-gray-300 text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-purple-200 focus:border-purple-500 transition-colors"
                  required
                />
              </div>
            </div>
