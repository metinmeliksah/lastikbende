...
export default function Hakkimizda() {
  return (
    <div className="min-h-screen bg-dark-400 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-center text-white mb-8">Hakkımızda</h1>
        
        <div className="bg-dark-300 shadow-lg rounded-lg p-6 mb-8">
        ...
        <div className="bg-dark-300 shadow-lg rounded-lg p-6 mb-8">
          <h2 className="text-2xl font-semibold text-white mb-4">Misyonumuz</h2>
          <p className="text-gray-300 mb-4">
        ...
        <div className="bg-dark-300 shadow-lg rounded-lg p-6 mb-8">
          <h2 className="text-2xl font-semibold text-white mb-4">Vizyonumuz</h2>
          <p className="text-gray-300 mb-4">
            İkinci el lastik pazarında güvenin ve kalite standartlarının temsilcisi olmak.
          </p>
        </div>

        <div className="bg-dark-300 shadow-lg rounded-lg p-6">
          <h2 className="text-2xl font-semibold text-white mb-4">Neden Lastik Bende?</h2>
